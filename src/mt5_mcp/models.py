...
class IndicatorSpec(BaseModel):
    ...
    column_name: Optional[str] = Field(
        None,
        description="Output column name (auto-generated if not provided)"
    )
...
class ChartPanel(BaseModel):
    ...
    columns: List[str] = Field(
        ...,
        description="Column names to plot in this panel",
        min_length=1
    )
    
    style: str = Field(
        default="line",
        description="Plot style: 'line', 'scatter', 'bar'"
    )
    ...
    reference_lines: Optional[List[float]] = Field(
        None,
        description="Horizontal reference lines (e.g., [30, 70] for RSI)"
    )
...
class MT5AnalysisRequest(BaseModel):
    ...
    query: MT5QueryRequest = Field(
        ...,
        description="MT5 data query configuration"
    )
    ...
    chart: Optional[ChartConfig] = Field(
        None,
        description="Chart generation configuration (omit for data-only response)"
    )
            ...
            "examples": [
                {
                    ...
                    "chart": {
                        ...
                        "panels": [
                            ...
                            {"columns": ["rsi"], "style": "line", "y_limits": [0, 100], "reference_lines": [30, 70]}
                        ],
